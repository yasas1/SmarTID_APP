...
public class CardActivity extends AppCompatActivity {
    ...
    private String fseid;//avi="1";
    private String shopname;//="Naduli Communication";
        ...
        btnGet.setOnClickListener(
                new View.OnClickListener(){
                    ...
                    public void onClick(View v){
                        ...
                        Double stock50=Double.parseDouble(tcount50.getText().toString());
                        ...
                        Double stock100=Double.parseDouble(tcount100.getText().toString());
                        ...
                        Double stock500=Double.parseDouble(tcount500.getText().toString());
                        ...
                        Double stock1000=Double.parseDouble(tcount1000.getText().toString());
    ...
    public boolean checkDisCard(){
        String end1=textView1end.getText().toString();
        String end2=textView2end.getText().toString();
        String end3=textView3end.getText().toString();
        String end4=textView4end.getText().toString();
        String end5=textView5end.getText().toString();
        int count=0;
        boolean result=true;
    ...
    public void OnSellBtn(View view){
        ...
        if((tvPriceTot.getText().toString()=="")||tvPriceTot.getText().toString()=="0"){
            Toast.makeText(getApplicationContext(),"first press GET_PRICE",Toast.LENGTH_LONG).show();
        }/*else if(checkDisCard()==false){
            Toast.makeText(getApplicationContext(),"first press Get Card Button",Toast.LENGTH_LONG).show();
        }*/
        else {
    ...
    public class BackgroundTask extends AsyncTask<Void,Void,String> {
        ...
        protected void onPreExecute() {
            ...
            json_url="http://192.168.43.45/smartid/jasonCards.php";
        }
        ...
        new android.support.v7.app.AlertDialog.Builder(this)
                ...
                .setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        Intent intent2 = new Intent(CardActivity.this, ShopActivity.class);
